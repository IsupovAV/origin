...
MainWindow::MainWindow(QWidget *parent)
    ...
    gr_ = new Graphic(this);
    connect(this, &MainWindow::sig_show, this, &MainWindow::show_graphic);
}
...
void MainWindow::on_pb_path_clicked() {
    ...
    pathToFile = QFileDialog::getOpenFileName(this, tr("Открыть файл"), "/home/",
                                              tr("ADC Files (*.adc)"));
...
void MainWindow::show_graphic(QVector<double> x, QVector<double> y)
{
    gr_->setWindowTitle("График канала " + ui->cmB_numCh->currentText());
    gr_->ClearGraphic();
    gr_->AddGraphic(x, y);
    gr_->show();
}

void MainWindow::AllOffCeckBox_()
{
